...
public:
    ...
    : wxFrame(NULL, wxID_ANY, title), value_left(0.0), value_right(0.0), rates_provider(std::move(_rates_provider)) {
        ...
        combobox_left = new wxComboBox(panel, wxID_ANY, "RUB", wxDefaultPosition, wxSize(100, -1),
                                    choices, wxCB_READONLY);

        combobox_right = new wxComboBox(panel, wxID_ANY, "BYN", wxDefaultPosition, wxSize(100, -1),
                                    choices, wxCB_READONLY);
        ...
        grid->Add(combobox_left, 0, wxBOTTOM | wxLEFT | wxRIGHT, 10);
        grid->Add(combobox_right, 0, wxBOTTOM | wxLEFT | wxRIGHT, 10);
        grid->Add(0, 0);
...
private:
    ...
    wxComboBox* combobox_left;
    wxComboBox* combobox_right;
    ...
    void OnCustomRateCheckboxChange(wxCommandEvent& event) {
        ...
        combobox_left->Enable(!custom_rate_state);
        combobox_right->Enable(!custom_rate_state);
